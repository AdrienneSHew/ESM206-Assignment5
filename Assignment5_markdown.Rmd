...
#########################################################################################
#create graph of shift in PhDs awarded to women (separated  by field) over the years (must create new original data frame including all years)

PHDs_women_table<-PHDs_women %>% 
  kable() %>% 
  kable_styling()
